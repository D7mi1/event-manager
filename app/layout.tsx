...
export const metadata: Metadata = {
  title: {
    default: "مِراس | منصة تنظيم الفعاليات والمناسبات في السعودية",
    template: "%s | منصة مِراس"
  },
  description: "المنصة الأولى في السعودية لتنظيم حفلات الزفاف والتخرّج والمؤتمرات والمعارض. دعوات رقمية، تسجيل حضور بـ QR، رسائل واتساب تلقائية، وتحليلات ذكية.",
  ...
  openGraph: {
    ...
    siteName: 'مِراس',
    title: 'مِراس | منصة تنظيم الفعاليات والمناسبات في السعودية',
    description: 'المنصة الأولى في السعودية لتنظيم حفلات الزفاف والتخرّج والمؤتمرات والمعارض. دعوات رقمية، تسجيل حضور بـ QR، ورسائل واتساب تلقائية.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'مِراس | منصة تنظيم الفعاليات والمناسبات في السعودية',
    description: 'المنصة الأولى في السعودية لتنظيم حفلات الزفاف والتخرّج والمؤتمرات والمعارض.',
